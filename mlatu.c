...
// todo: linked list of numbers of defs
I dbg=0, ch;
...
I main(I ac,C *av) { 
	...
	D rs[10]={0}; P aP=nP(aF,""); P qP=nP(qF,"");
	D r=nD(2,aP,nP(0,"r")); r->f=rPtv; rs[1]=r;    D d=nD(2,aP,nP(0,"d")); d->f=dPtv; r->n=d;
	D q=nD(2,aP,nP(0,"q")); q->f=qPtv; d->n=q;     D u=nD(2,qP,nP(0,"u")); u->f=uPtv; q->n=u;
	D s=nD(3,aP,aP,nP(0,"s")); s->f=sPtv; rs[2]=s; D c=nD(3,qP,qP,nP(0,"c")); c->f=cPtv; s->n=c;
	C t=ma(100); I i, l;
